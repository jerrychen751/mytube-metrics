...
class Channels:
    ...
    def list(self, part: str = "id,snippet,contentDetails,statistics,topicDetails",
        ...
        Args:
            ...
            max_results (int): The maximum number of items to return in response (1-50).
        ...
        # Make API requrest to list page of channels
    ...
    def process_raw_stats(raw_channel_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        Process the response from the YouTube Data API for channels resource.

        Args:
            raw_channel_stats (Dict[str, Any]): Response from the YouTube Data API to list channels data.
        ...
        for channel_resource in raw_channel_data.get('items', []):
            ...
            data = {
                ...
                "wiki_topic_urls": topic_details.get('topicCategories', [])
            }
